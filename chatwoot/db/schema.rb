...
ActiveRecord::Schema[7.1].define(version: 2026_03_09_184530) do
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.decimal "deal_value", precision: 15, scale: 2, default: "0.0"
    ...
    t.index ["kanban_column_id"], name: "index_conversations_on_kanban_column_id"
  ...
  add_foreign_key "conversations", "kanban_columns"
