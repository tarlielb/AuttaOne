...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Autta.ONE',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Autta.ONE.',
    created_at: 1736143273,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Autta.ONE',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Autta.ONE',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | Autta.ONE',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Autta.ONE.',
    created_at: 1736143276,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
    name: 'Managing Tickets | User Guide | Autta.ONE',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    id: 3064,
    name: 'Financial Reporting | User Guide | Autta.ONE',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Autta.ONE deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Autta.ONE' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Autta.ONE?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Autta.ONE' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Autta.ONE?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Autta.ONE' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Autta.ONE?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Autta.ONE' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Autta.ONE?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Autta.ONE' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Autta.ONE allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Autta.ONE?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Autta.ONE' },
